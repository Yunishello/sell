							  ...
							  @if(count($posts) > 0)
								  ...
								  <ul class="list">
									  <a href="/posts/{{$post->id}}">
										  <li>
										  <img src="{{ asset('/storage/images/'.$post->image) }}" title="" alt="" />
										  <section class="list-left">
										  <h5 class="title" style="text-transform: uppercase;">{{$post->title}}</h5>
										  <span class="adprice">&#8358;{{$post->price}}</span>
										  <p class="catpath">{{$post->category}} » {{$post->brand}}</p>
										  </section>
										  <section class="list-right">
										  <span class="date">{{$post['created_at']->diffForHumans()}}</span>
										  <span class="cityname">{{$post->location}}</span>
										  </section>
										  <div class="clearfix"></div>
										  </li> 
									  </a>
								...
								@else
									  <p style="font-size: 30px;">No Post Found</p>
							  @endif
					  </div>
						  </div>
					  </div>
